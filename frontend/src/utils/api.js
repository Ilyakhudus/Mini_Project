...
export const pollsAPI = {
  ...
  respondToPoll: (pollId, optionIndex) => api.post(`/polls/${pollId}/respond`, { selectedOption: optionIndex }),
  closePoll: (pollId, isActive = false) => api.put(`/polls/${pollId}/status`, { isActive }),
