    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-700 mb-4">You don't have permission to view this budget analysis</p>
          <button
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-700 text-sm mb-2">Amount Spent</p>
            <p className="text-3xl font-bold text-red-600">${budget?.spent || 0}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <p className="text-gray-700 text-sm mb-2">Remaining Budget</p>
        ...
        {budget && (
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <p className="text-sm text-gray-700">{budgetPercentage.toFixed(1)}% of budget used</p>
          </div>
        )}
