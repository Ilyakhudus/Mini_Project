    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md text-center">
          ...
          <p className="text-gray-700 mb-4">Redirecting you to your events...</p>
          <Link
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-b-xl shadow-lg p-6">
          <p className="text-gray-700 text-center mb-4">Sign in or create an account to register for this event</p>
          ...
          <div className="mt-4 text-center">
            <Link to={`/events/${eventId}`} className="text-sm text-gray-700 hover:text-blue-600">
