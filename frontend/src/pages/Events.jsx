          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <input
                type="text"
                ...
                maxLength={6}
                className="w-full sm:w-40 px-4 py-2 border border-gray-300 rounded-lg text-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono uppercase"
              />
