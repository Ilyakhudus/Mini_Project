    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-700">Loading your hub...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700">Discover events and manage your registrations</p>
        </div>
        ...
        {activeTab === "explore" && (
          <div>
            ...
            <p className="text-gray-700 mb-6">Discover both open and invite-only events</p>
              ...
              <form onSubmit={handleInviteCodeRegister} className="flex flex-col md:flex-row gap-3">
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    maxLength={4}
                  />
                </div>
                <button
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="md:col-span-1">
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg text-green-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                <div>
                  <select
        ...
        {activeTab === "updates" && (
          <div>
            ...
            <p className="text-gray-700 mb-6">Stay informed about your upcoming events and messages from organizers</p>
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              {message.messageType === "text" && <p className="text-gray-700">{message.content}</p>}

                              {message.messageType === "poll" && message.pollOptions && (
                                <div className="mt-3 space-y-3">
                                  <p className="text-gray-700 font-medium mb-3">{message.content}</p>
                        ...
                        >
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-gray-700 text-sm mt-1">{update.message}</p>
            ...
            <div className="p-6">
              ...
              {selectedEvent.detailedDescription && (
                <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{selectedEvent.detailedDescription}</p>
                </div>
              )}
              ...
              {selectedEvent.activitiesAndBenefits && (
                <div className="mb-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{selectedEvent.activitiesAndBenefits}</p>
                </div>
              )}
